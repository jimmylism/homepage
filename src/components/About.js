...
export default function About() {
    return (
        <div className="section" id="about">
            ...
            <h2 className="sectionHeader" style={{marginTop: '4rem'}}>Outside of work:</h2>
            <div className="aboutText container">
                <p className="hobbies">Practicing Spanish</p>
                <p className="miniDescription">The goal is to backpack through Latin America one day.</p>
                <p className="hobbies">Learning Go</p>
                ...
                <p className="hobbies">Playing pickleball</p>
